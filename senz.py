...
def func(brand_input, company_input,company_name_map,company_name_list, data_df):
        try:
            ...
            company_matches_map = {i[0]: i[2] for i in company_matches} #map of company name and conf_level of the match
...
if __name__ == '__main__':
    brand_input = 'CYTOXAN TAB 25MG'
    company_input = 'BRISTOL-MYERS SQUIBB CANADA'
    try:
        print(func(brand_input, company_input,company_name_map,company_name_list, data_df))
    except Exception as e:
        print(e)